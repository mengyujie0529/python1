...
class Tree():
    ...
    def randomAppear(self):
        ...
        #     listTreeX.append(random.randint(0,window.get_width()-42))
        # for y in range(treeNum):
        #     listTreeY.append(random.randint(0,window.get_height()-48))
        # for i in range(treeNum):
        #     tree=window.blit(self.imaTree,listTreeX[i],listTreeY[i])
        #     listTree.append()
